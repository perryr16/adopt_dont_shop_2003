...
RSpec.describe "Pets can be seen on shelter pet ", type: :feature do
  it "can view a pet on shelter pet page" do
    ...
    expect(page).not_to have_content(pet2.shelter_name)
    ...
    # expect(page).not_to have_content(pet3.shelter)
    ...
    expect(page).to have_content(pet4.shelter_name)
